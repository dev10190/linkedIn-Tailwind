...
const Business = () => {
  ...
  return (
    <div className="relative">
      ...
      {option && (
        <div className="absolute top-16 right-2 z-20 bg-white p-10 border border-gray-400 rounded-xl w-[650px] flex flex-col gap-3">
              ...
              <div className="flex flex-col gap-7">
                <div className=" flex flex-col gap-4">
                  <div className="flex items-center gap-6 hover:underline cursor-pointer">
                    <img className="w-9" src={find} alt="" />
                    <p className="text-[16px] font-semibold text-gray-800 ">
                      Find Leads
                    </p>
                  </div>
                  <div className="flex items-center gap-6 hover:underline cursor-pointer">
                    <img className="w-9" src={group} alt="" />
                    <p className="text-[16px] font-semibold text-gray-800">
                      Groups
                    </p>
                  </div>
                ...
                <div className=" flex flex-col gap-5">
                  ...
                  <div className="flex flex-col gap-4">
                    <div className="flex items-center gap-6 hover:underline cursor-pointer">
                      <img className="w-9" src={talent} alt="" />
                      <p className="text-[16px] font-semibold text-gray-800">
                        Talent Insights
                      </p>
                    </div>
                    <div className="flex items-center gap-6 hover:underline cursor-pointer">
                      <img className="w-9" src={jobs} alt="" />
                      <p className="text-[16px] font-semibold text-gray-800">
                        Post a job
                      </p>
                    </div>
                ...
                <div className=" flex flex-col gap-5">
                  ...
                  <div className="flex items-center gap-6 hover:underline cursor-pointer">
                    <img className="w-10" src={advertise} alt="" />
                    <p className="text-[16px] font-semibold text-gray-800">
                      Advertise
                    </p>
                  </div>
